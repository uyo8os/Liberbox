...
export default function SpeedtestShare({
    ...
    const generateImage = async () => {
      ...
      try {
        ...
        const drawShareCard = () => {
          ...
          ctx.fillStyle = "#1E293B"; // 深蓝灰色
          ctx.fillText("Liberbox 网络测速", 180, 85);
  ...
  const handleShare = async () => {
    try {
      ...
      if (navigator.share && navigator.canShare) {
        ...
        // 创建File对象
        const file = new File([blob], "speedtest-result.png", {
          type: "image/png",
        });
  ...
  const handleDownload = () => {
    ...
    link.href = shareUrl;
    link.download = "Liberbox-测速结果.png";
